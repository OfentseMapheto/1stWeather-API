			...
			<div class="wrapper">
				...
				<div class="centre success">
					...
					<div class="temperature">
						...
						<div class="tempSecondary">
							<span id="tempHigh">{this.state.tempHigh}°</span>
							<span id="tempDivider">|</span>
							<span id="tempLow">{this.state.tempLow}°</span>
						</div>
					</div>
					...
					<div class="humidWind">
						<div id="humidWindNames">
							<div>Humidity:</div>
							<div>Wind Speed:</div>
						</div>
						<div id="secondaryDivider"> </div>
						<div id="humidWindValues">
							<div>{this.state.humidity}%</div>
							<div>{this.state.windSpeed} {this.state.unitsSpeed}</div>
						</div>
					</div>
				</div>
			</div>
			...
			<div class="wrapper">
				...
				<div class="centre invalid">
					<div class="paragraphContainer">
						...
						<div class="errorDesc">
							<p>The zipcode that you have entered; "{this.state.zip}", is invalid.<br/><br/>When entering the zipcode, please make sure that that it only contains numerical characters and is four digits long.</p>
						</div>
					</div>
				</div>
			</div>
